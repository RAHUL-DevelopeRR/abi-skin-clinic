...
const BRANCHES = [
  {
    ...
    mapLink: 'https://maps.google.com/?q=Abi+Skin+and+Hair+Clinic+Karur',
  ...
  },
  {
    ...
    mapLink: 'https://maps.google.com/?q=Abi+Skin+and+Hair+Clinic+Velayuthampalayam',
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {BRANCHES.map((branch, index) => (
            <SpotlightCard 
              key={index}
              className="rounded-3xl bg-white dark:bg-slate-950 border border-slate-200/60 dark:border-slate-800/80 p-8 shadow-sm flex flex-col justify-between"
            >
              <div>
                {/* Branch Header */}
